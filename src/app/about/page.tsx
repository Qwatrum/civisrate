...
export default function About() {
    ...
    return (
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <h1 className="text-3xl font-bold mb-5 mt-10">Information</h1>
          <ul>
            <li className="main-font">The current ratings were calculated using free statistics and surveys.</li>
